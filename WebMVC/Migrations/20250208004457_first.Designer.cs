...
namespace WebMVC.Migrations
{
    ...
    [Migration("20250208004457_first")]
    partial class first
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebMVC.Models.Move", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebMVC.Models.PokemonDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebMVC.Models.PokemonTreinadorRelacionado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebMVC.Models.Treinador", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebMVC.Models.PokemonTreinadorRelacionado", b =>
                {
                    ...
                    b.HasOne("WebMVC.Models.Pokemon", "PokemonApiId")
                        .WithMany("Pokemons")
                        .HasForeignKey("PokemonApiIdId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebMVC.Models.Treinador", "Treinador")
                        .WithMany("Pokemons")
